...
window.DM.gallery = function() {
  var $thumbs = $( '.store-gallery-thumb a' );
  var $gallery = $( '.store-gallery-lg' );
  $thumbs.each( function( i, el ) {
    $( el ).on( 'click', function( e ) {
      $gallery.find( 'li' ).removeClass( 'is-showing' )
        .eq( i ).addClass( 'is-showing' );
      $thumbs.removeClass( 'is-viewing' );
      $( e.target ).addClass( 'is-viewing' );
    });
  });
  $gallery.find( 'li' ).removeClass( 'is-showing' )
...
window.DM.modal = function() {
  ...
  window.DM.modal.close = function() {
  ...
  window.DM.modal.open = function( modal ) {
...
window.DM.vimeo.play = function( el ) {
  el = el || false;
  if( el.length )
    el.contentWindow.postMessage( { "method" : "play" }, el.src );
};

window.DM.vimeo.pause = function( el ) {
  el = el || false;
  if( el.length )
